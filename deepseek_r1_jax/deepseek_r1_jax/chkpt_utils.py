...
def r1_config() -> Config:
    return Config(
        ...
        rope_original_max_position_embeddings=R1_ROPE_SCALING["original_max_position_embeddings"],
        ffw_size=18432,
        first_k_dense=3,
...
def load_torch_model(params_map: dict[str, dict[str, Any]], root_path: Path, config: deepseek.DeepseekV3Config):
